...
1. **[Adaptive Chunk-Based Dynamic Weighted Majority for Imbalanced Data Streams With Concept Drift](https://ieeexplore.ieee.org/document/8924892)** paper from Yang Lu, et al.

2. **[Dynamic Weighted Majority for Incremental Learning of Imbalanced Data Streams with Concept Drift](https://www.ijcai.org/proceedings/2017/333)** paper from Yang Lu, et al.

3. **[Kappa Updated Ensemble for drifting data stream mining](https://link.springer.com/article/10.1007/s10994-019-05840-z)** paper from Alberto Cano and Bartosz Krawczyk .

4. **[Incremental learning imbalanced data streams with concept drift: The dynamic updated ensemble algorithm](https://www.researchgate.net/publication/339548379_Incremental_learning_imbalanced_data_streams_with_concept_drift_The_dynamic_updated_ensemble_algorithm)** paper from Zeng Li
, et al.

5. **[Dynamic Segmentation for Physical Activity Recognition Using a Single Wearable Sensor](https://www.mdpi.com/2076-3417/11/6/2633)** paper by Nora Alhammad and Hmood Al-Dossari .

6. **[Hybrid fuzzy c-means CPD-based segmentation for improving sensor-based multiresident activity recognition](https://ieeexplore.ieee.org/document/9324819)** paper from D. Chen, et al.
